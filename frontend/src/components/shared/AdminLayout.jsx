...
export default function AdminLayout({
  ...
  const NavItem = ({
    ...
    return <Link to={to} className={`admin-nav-item${active ? ' admin-nav-item--active' : ''}`}>
        <span className={css({
        flexShrink: 0,
  ...
  return <div className="admin-layout">
      ...
      <aside className="admin-sidebar">
        ...
        <nav className="admin-sidebar__nav">
          ...
          <NavItem to="/admin/dashboard" label="Tổng quan" icon={<svg width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><rect x="3" y="3" width="7" height="7" rx="1" /><rect x="14" y="3" width="7" height="7" rx="1" /><rect x="3" y="14" width="7" height="7" rx="1" /><rect x="14" y="14" width="7" height="7" rx="1" /></svg>} />

          <SectionLabel label="Quản lý" />
          <NavItem to="/admin/events" label="Sự kiện" badge={12} icon={<svg width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><rect x="3" y="4" width="18" height="18" rx="2" /><path d="M16 2v4M8 2v4M3 10h18" /></svg>} />
          <NavItem to="/admin/revenue" label="Doanh thu" icon={<svg width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" /></svg>} />
          <NavItem to="/admin/users" label="Khán giả" icon={<svg width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2" /><circle cx="9" cy="7" r="4" /><path d="M23 21v-2a4 4 0 00-3-3.87M16 3.13a4 4 0 010 7.75" /></svg>} />
          <NavItem to="/admin/account-management" label="Quản lý tài khoản" icon={<svg width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><circle cx="12" cy="7" r="4" /><path d="M5.5 21a6.5 6.5 0 0113 0" /><path d="M17 11l2 2 4-4" /></svg>} />
  
          <SectionLabel label="Cài đặt" />
          <NavItem to="/admin/settings" label="Cài đặt" icon={<svg width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="3" /><path d="M19.4 15a1.65 1.65 0 00.33 1.82l.06.06a2 2 0 010 2.83 2 2 0 01-2.83 0l-.06-.06a1.65 1.65 0 00-1.82-.33 1.65 1.65 0 00-1 1.51V21a2 2 0 01-4 0v-.09A1.65 1.65 0 009 19.4a1.65 1.65 0 00-1.82.33l-.06.06a2 2 0 01-2.83-2.83l.06-.06A1.65 1.65 0 004.68 15a1.65 1.65 0 00-1.51-1H3a2 2 0 010-4h.09A1.65 1.65 0 004.6 9a1.65 1.65 0 00-.33-1.82l-.06-.06a2 2 0 012.83-2.83l.06.06A1.65 1.65 0 009 4.68a1.65 1.65 0 001-1.51V3a2 2 0 014 0v.09a1.65 1.65 0 001 1.51 1.65 1.65 0 001.82-.33l.06-.06a2 2 0 012.83 2.83l-.06.06A1.65 1.65 0 0019.4 9a1.65 1.65 0 001.51 1H21a2 2 0 010 4h-.09a1.65 1.65 0 00-1.51 1z" /></svg>} />
        </nav>

        {/* Bottom: theme toggle + logout */}
        <div className="admin-sidebar__footer">
          <button className="admin-sidebar__theme-btn" onClick={toggleTheme} title={theme === 'dark' ? 'Chuyển sang theme sáng' : 'Chuyển sang theme tối'}>
            {theme === 'dark' ? <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
