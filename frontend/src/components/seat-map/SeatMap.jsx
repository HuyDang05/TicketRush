...
export default function SeatMap({
  ...
  return <div className="seat-map">
      ...
      <div className="seat-map__legend">
        {LEGEND.map(item => <div key={item.label} className="seat-map__legend-item">
            <div className={cx("seat-map__legend-dot", css({
      ...
      <div className="seat-map__zones">
        ...
        return <div key={zone.id} className={cx("seat-zone", css({
          background: '#0D0D0D',
          borderColor: `${accentColor}33`
        }, "SeatMap"))}>
              <div className={cx("seat-zone__header", css({
            borderBottom: `1px solid ${accentColor}22`,
            background: `${accentColor}0D`
          }, "SeatMap"))}>
                <div className="seat-zone__header-left">
                  <div className={cx("seat-zone__dot", css({
                ...
                <div className="seat-zone__header-right">
                  ...
                  <span className={cx("seat-zone__price", css({
                color: accentColor
              }, "SeatMap"))}>
              ...
              <div className="seat-zone__body">
                {zone.seats && zone.seats.length > 0 ? <SeatGrid seats={zone.seats} selectedSeats={selectedSeats} onSelectSeat={onSelectSeat} zonePrice={zone.price} accentColor={accentColor} /> : <div className="seat-zone__no-seats">Không có ghế trong khu vực này</div>}
              </div>
            </div>;
      })}
      </div>
