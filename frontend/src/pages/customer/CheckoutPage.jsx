...
export default function CheckoutPage() {
  ...
  useEffect(() => {
    if (currentBookings.length === 0) {
      ...
      navigate(eventId ? `/events/${eventId}/seats` : '/', {
        replace: true
      });
    }
  ...
  const dateStr = eventDate ? new Date(eventDate).toLocaleDateString('vi-VN', {
    weekday: 'long',
    day: '2-digit',
    month: '2-digit',
    year: 'numeric'
  }) : '';
  const timeStr = eventDate ? new Date(eventDate).toLocaleTimeString('vi-VN', {
    hour: '2-digit',
    minute: '2-digit'
  }) : '';
    ...
    try {
      ...
      if (status === 410 || status === 409) {
        toast.error('Phiên giữ chỗ đã hết hạn', {
          description: 'Vui lòng chọn lại ghế.'
        });
        refreshCart();
        setTimeout(() => navigate(eventId ? `/events/${eventId}` : '/', {
          replace: true
        }), 1800);
      } else {
        toast.error(msg);
      ...
      <div className="checkout-layout">
        ...
        <div className="checkout-left">
          ...
          <div className="checkout-card">
            ...
            <div className="checkout-event">
              ...
              <div className="checkout-event__meta">
                ...
                {dateStr && <div className="checkout-event__meta-item">
                ...
                {eventVenue && <div className="checkout-event__meta-item">
          ...
          <div className="checkout-card">
            ...
            <div className="checkout-ticket-list">
              {currentBookings.map(b => <div key={b.bookingId} className="checkout-ticket">
          ...
          <div className="checkout-card">
            ...
            <div className="checkout-info-notice">
              ...
              flexShrink: 0,
              marginTop: 1
            }, "CheckoutPage")}><circle cx="12" cy="12" r="9" /><path d="M12 8v4M12 16h.01" /></svg>
              <div>
                Vé điện tử sẽ được gửi đến email <strong className={css({
                color: '#fff'
              }, "CheckoutPage")}>{user?.email || '—'}</strong> sau khi thanh toán thành công.
              </div>
            </div>
          </div>
        ...
        <div className="checkout-sidebar">
          <div className="checkout-summary">
            ...
            <button className={`checkout-confirm-btn${success ? ' checkout-confirm-btn--success' : ''}`} onClick={handleConfirm} disabled={confirming || success}>
              {success ? <>
              ...
              }, "CheckoutPage")}><path d="M21 12a9 9 0 11-6.219-8.56" /></svg>
                  Đang xử lý...
                </> : <>
