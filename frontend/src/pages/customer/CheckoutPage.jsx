    ...
    <div className="checkout-page">
      ...
      <div className="checkout-layout">
        ...
        <div className="checkout-left">
          ...
          {/* Seat list */}
          <div className="checkout-card">
            <div className="checkout-card__title">Chi tiết vé ({bookings.length} vé)</div>
        ...
        <div className="checkout-sidebar">
          <div className="checkout-summary">
            ...
            <div className="checkout-countdown-box">
              <div className="checkout-countdown-box__left">
                ...
                <div>
                  <div className="checkout-countdown-box__label">Đơn hàng hết hạn sau</div>
                  <div className="checkout-countdown-box__sublabel">Hoàn tất trước khi hết giờ</div>
                </div>
              </div>
