...
export default function RegisterPage() {
  ...
  const [formData, setFormData] = useState({ email: '', password: '', confirmPassword: '', fullName: '', dob: '', gender: 'MALE' });
  ...
  return (
    <div className="auth-page">
      ...
      <div className="auth-panel--left">
        ...
        {LIGHT_BEAMS.map((l, i) => (
          <div key={i} style={{
            position: 'absolute', top: 0, left: l.left, width: l.width, height: '100%',
