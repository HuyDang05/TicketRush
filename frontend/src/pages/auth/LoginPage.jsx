...
const LIGHT_BEAMS = [
  ...
  { left: '35%', width: 200, rot: '-6deg',  color: '#fff' },
  { left: '56%', width: 180, rot: '10deg',  color: '#FF6B35' },
  { left: '72%', width: 150, rot: '24deg',  color: '#fff' },
];
      ...
      <div className="auth-panel--left">
        ...
        {LIGHT_BEAMS.map((l, i) => (
          <div key={i} style={{
            ...
            width: l.width, height: '100%',
            opacity: 0.12, transformOrigin: 'top center', transform: `rotate(${l.rot})`,
        ...
        <div className="auth-form-wrap">
          ...
          <form onSubmit={handleSubmit} className="auth-form">
            ...
            <div className="auth-field">
              ...
              <Link to="/forgot-password" className="auth-forgot-link" style={{ alignSelf: 'flex-end', marginTop: '8px' }}>Quên mật khẩu?</Link>
            </div>

            <button type="submit" disabled={isLoading} className="auth-submit" style={{ marginTop: '16px' }}>
              {isLoading && (
...
function MiniCard({ ev }) {
  return (
    <div className="mini-card">
      <div className="mini-card__img" style={{ background: ev.bg }}>
        {ev.emoji}
      </div>
